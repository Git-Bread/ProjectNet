...
namespace ProjectNet
{
    internal class HolyScripture
    {
        public static void Scripture()
        {
            ...
            " The Earth is the lowest plane, the center of the celestial bodies, all rotate around earth and all will eventually fall to the Earth. Thats why the Earth is polluted with Sin, while the heaven remains pure. - Hierodommus 17:7",
            ...
            Console.Clear();
            Console.WriteLine();
            TextFunctions.SlowPrint(Scriptures[random.Next(0, Scriptures.Length)]);
        }
    }
}